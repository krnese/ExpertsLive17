...
param(
    ...
    [Parameter()]
    [ValidateNotNullOrEmpty()]
    [string] $ManagedApplicationName = 'ExpertsLiveWebApp',

    [Parameter()]
    [ValidateNotNullOrEmpty()]
    [string] $ManagedApplicationDisplayName = 'ExpertsLive WebApp',

    [Parameter()]
    [ValidateNotNullOrEmpty()]
    [string] $ManagedApplicationDescription = 'Managed Web App (demo)',
